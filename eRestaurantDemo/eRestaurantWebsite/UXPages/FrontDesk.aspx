...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
     ...
     <div class="well">
        <div class="pull-right col-md-5">
            ...
            <asp:ObjectDataSource runat="server" ID="AdHocBillDateDataSource" OldValuesParameterFormatString="original_{0}" SelectMethod="GetLastBillDateTime" TypeName="eResturauntSystem.BLL.AdminController"></asp:ObjectDataSource>
        </div>
     ...
     <div class="col-md-7">
        <details open>
            ...
            <asp:GridView ID="SeatingGridView" runat="server" AutoGenerateColumns="False"
                    ...
                    DataSourceID="SeatingObjectDataSource" ItemType="eResturauntSystem.Entities.POCOs.SeatingSummary">
                <Columns>
    ...
    <asp:ObjectDataSource runat="server" ID="SeatingObjectDataSource" OldValuesParameterFormatString="original_{0}"
        SelectMethod="SeatingByDateTime" TypeName="eResturauntSystem.BLL.AdminController">
        <SelectParameters>
    ...
    SelectMethod="ListWaiters" TypeName="eResturauntSystem.BLL.AdminController"></asp:ObjectDataSource>

    <!-- this is the presentation markup code for the reservation display -->
        <div class="pull-right col-md-5">
            <!--Details is a coloapsable bootstrap colapsable area-->
        <details open>
            <!--Summary: the text displayed by the details icon-->
            <summary>Reservations by Date/Time</summary>
            <h4>Today's Reservations</h4>
            <!--ItemType= parameters must be directed to ypoour current aplication locations-->
            <asp:Repeater ID="ReservationsRepeater" runat="server"
                ItemType="eResturauntSystem.Entities.DTO.ReservationCollection" DataSourceID="ReservationsDataSource">
                <ItemTemplate>
                    <div>
